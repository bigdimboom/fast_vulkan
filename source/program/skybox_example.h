...
#include "../engine/renderer/skybox_rdr.h"
...
class SkyboxExample : public app::VulanAppBase, public app::IUserInput
{
public:
	SkyboxExample();
	SkyboxExample(int argc, const char** argv);
	~SkyboxExample();

	SkyboxExample(const SkyboxExample&) = delete;
	SkyboxExample(SkyboxExample&&) = delete;
	void operator=(const SkyboxExample&) = delete;
	void operator=(SkyboxExample&&) = delete;
...
private:
	...
	std::unique_ptr<renderer::SkyboxRdr> d_skyBox;
